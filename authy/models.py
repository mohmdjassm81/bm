...
class Profile(models.Model):
    ...
    locationY = models.FloatField(max_length=2, null=True, blank=True)
    locationX = models.FloatField(max_length=200, null=True, blank=True)

    url = models.URLField(max_length=200, null=True, blank=True)
    favourite = models.ManyToManyField(Post, blank=True)
    im_on = models.BooleanField(default=False, null=True)
    castmr_on = models.BooleanField(default=False, null=True)
    serch = models.CharField(max_length=200, null=True, blank=True)
